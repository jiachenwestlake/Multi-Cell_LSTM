...
def read_instance(input_file, task, word_alphabet, char_alphabet, feature_alphabets, label_alphabet, entity_alphabet, number_normalized, max_sent_length, sentence_classification=False, split_token='\t', char_padding_size=-1, char_padding_symbol = '</pad>'):
